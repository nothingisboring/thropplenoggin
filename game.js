...
function blockAndObscureClue(container, front, clueData) {
    ...
    if (normalizedGuess === normalizedSolution) {
        ...
        function endGameCelebration(){ puzzleTitleEl.textContent="Oblique solved!"; messageAreaEl.classList.add('final-celebration'); displayMessage('🧠😈 Congratulations! You are truly devious! 😈🧠', 'text-purple-600'); } // text-purple-600 uses variable now
